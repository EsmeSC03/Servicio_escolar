...
<body>
    ...
    <div class="container">
        ...
        <header>
            ...
            <div class="logo">Servicio social</div>
            <nav>
                <ul>
        ...
        <div class="gallery">
            ...
            <button class="button">Datos de servicio</button>
        </div>




        <div id="convocatorias" style="display:none">
    ...
    <div id="crearConvocatoria" style="display: none; text-align: center; border-radius: 100px;">
        <div style=" padding: 10px;">
            <h2>Mi informacion</h2>
            <img class="alumno" src="https://cdn-icons-png.flaticon.com/512/1046/1046270.png" width="30%" height="120px"
                alt="imagen del alumno" style="display: block; margin: 0 auto;">
    ...
    <div id="informacion">
        ...
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/Comisi%C3%B3n_Federal_de_Electricidad_%28logo%29_.svg/2560px-Comisi%C3%B3n_Federal_de_Electricidad_%28logo%29_.svg.png" alt="Logo de la empresa">
