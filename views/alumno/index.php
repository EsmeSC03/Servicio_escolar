...
<body>
    ...
    <h2>Hola 'Estudiante'</h2>
        <div>
            <a href="<?php echo constant('URL'); ?>perfil"><img data-user="spiderman" src="https://cdn-icons-png.flaticon.com/512/53/53083.png" alt="spiderman" class="seleccion-avatar" style="cursor:pointer" title="Consultar mi informacion"></a>
            <p>Actualmente has entregado 2 reportes: </p>

            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/PDF_file_icon.svg/1667px-PDF_file_icon.svg.png" style="max-width: 100%;" width="10%" height="10%"> &nbsp;&nbsp;&nbsp;&nbsp;
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/PDF_file_icon.svg/1667px-PDF_file_icon.svg.png" style="max-width: 100%;" width="10%" height="10%">
            <p>Has completado 336 horas, recuerda que al completar las 480 debes realizar el siguiente reporte</p>
            <p>Recuerda que puedes completar el reporte desde la seccion "Mis reportes"</p>
        </div>
    </div>
